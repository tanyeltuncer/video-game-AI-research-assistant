...
class Agent:
    ...
    def _tool_step(self, state: AgentState) -> AgentState:
        ...
        for call in tool_calls:
            ...
            # Set "owner"-parameter automatically for session_id for long-term memory
            if "owner" in tool.signature.parameters and "owner" not in function_args:
                function_args["owner"] = state.get("session_id", "default_user")
